...
- **Efficient File Output**: Fast asynchronous file writing with buffering
...
The plugin will create trace files in JSON format (e.g., `output_log.rank_0`, `output_log.rank_1`).
...
To read the trace logs:
```bash
# View the raw JSON
cat output_log.rank_0

# Pretty print with jq
cat output_log.rank_0 | jq .

# Or directly
jq . output_log.rank_0
```
...
- **Buffered Writing**: Efficient buffering reduces I/O operations
